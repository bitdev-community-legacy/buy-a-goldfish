...
var StyledImage = (0, _styledComponents["default"])(_gatsbyImage["default"])(_templateObject2(), function (props) {
  return props.theme.screen.md;
}, function (props) {
  return props.theme.screen.sm;
});

var ImageWrapper = _styledComponents["default"].div(_templateObject3(), function (props) {
  return props.theme.screen.md;
});
